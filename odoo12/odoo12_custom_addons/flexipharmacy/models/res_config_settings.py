...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            pos_amount_difference_account_id=int(param_obj.sudo().get_param('flexipharmacy.pos_amount_difference_account_id')) \
                if param_obj.sudo().get_param('flexipharmacy.pos_amount_difference_account_id') else False
        )
        return res
    ...
    def set_values(self):
        ...
        param_obj.sudo().set_param('flexipharmacy.pos_amount_difference_account_id',
                                   self.pos_amount_difference_account_id and self.pos_amount_difference_account_id.id or False)
        return res
    ...
    # Taken the below field to store the amount difference in the debit-credit while closing the session
    pos_amount_difference_account_id = fields.Many2one('account.account', string="Pos Amount Difference Account")
...
class res_company(models.Model):
    ...
    cr_no1 = fields.Char('CR No 1')
    cr_no2 = fields.Char('CR No 2')

...
class WizardMonthlyTimeBasedReport(models.TransientModel):
    _name = 'wizard.monthly.time.based.dashboard.report'
    ...
    def action_dashboard(self):
        ...
        return {
            'name': 'Monthly Time Based Report',
            'type': 'ir.actions.client',
            'tag': 'open_monthly_time_based_report_view',
